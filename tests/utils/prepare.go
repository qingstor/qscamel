...
func PrepareNormalTest(t testing.TB) (map[string]string, func(map[string]string) error) {
...
func PrepareDefaultTest(t testing.TB) (map[string]string, func(map[string]string) error) {
...
func PrepareDefinedTest(t testing.TB, filePerDir, dirPerDir int, fileSize int64, depth int) (map[string]string, func(map[string]string) error) {
	fileMap := CreateTestConfigFile(t, "copy", "fs", "fs", nil, nil)
